...
class AdditiveSynth:
    ...
    def generate_additive_wav(self, notes, type):
        ...
        for i in range(len(frequencies)):
            ...
            if self.wave_type == 'sine':
                ...
                #note: plots can be removed eventually, they are here temporarily to check the waveform shapes and overall amplitudes
                plt.plot(self.wave)
    ...
    def add_sine_waves(self, frequency, duration, amplitude):
        ...
        if (numHarmonics>1):
            ...
            x = amplitude * sumSines/max(sumSines)
...
class WavetableSynth:
    ...
    def generate_wavetable(self,  notes, timbre, sweep):
        ...
        for i in range(len(unique_freqs)):
            ...
            for j in range(0,11):
                ...
                #third dimension of wavetable corresponds to length of a single cycle of the waveform (values=amplitudes)
            ...
            if (frequency) != 0:
                ...
                if (sweep == 'static'):
                    ...
                    while num_samples_left > 0:
                        ...
                        #number of samples needed for current position in sweep, not taking into account length of cycle
